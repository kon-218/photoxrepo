...
#      assert(len(self.exc)==len(self.trans))
   ...
   def writeoutall(self,infile,outdir,message=""):
      ...
      toprint = message
      for un in xunits:
         outfile=outdir+"absspec."+name+".n"+str(self.nsample)+"."+str(self.pid)+'.'+un+".cross.dat"
      ...
      for un in xunits:
         outfile=outdir+"absspec."+name+".n"+str(self.nsample)+'.'+str(self.pid)+"."+un+".molar.dat"
         toprint += "\n\tPrinting spectrum in units [ "+un+", "+yunits+"] to "+outfile
         self.writeout(un, outfile,outdir)
      print(toprint)
   ...
   def writegeoms(self,infile,outdir):
      name = infile.split(".")[0]
      outfile = outdir+name+".n"+str(self.nsample)+"."+str(self.pid)+".geoms"
