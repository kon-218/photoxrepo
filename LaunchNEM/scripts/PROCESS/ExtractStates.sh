...
proc_dir=../PROCESS/   # directory with the grepping functions
input_dir=../../mol/ORCA_out/   # directory with the outputs of the calculations
output_dir=../../mol/Spectrum_data/Spectrum_in/   # directory with extracted data
if [ "$#" -ge 7 ]; then      # file with indices of geometries to use (one index per line).
    indices=$7               # leave empty or commented for using all geometries from istart to imax
fi  
#####################################################################
